function addFormOpcoes() {
	...
	id++;
	input.value = id;
	$("#divOpcoes").append("<p id=op_"+id+"><a href=\"#\" onclick=\"removeFormField('op_"+id+"'); return false;\" class=\"remove\"></a><textarea name=\"data[Opcao]["+id+"][nome]\" value=\"\" class=\"required\"></textarea></p>");
}
function addFormAlternativas() {
	...
	id++;
	input.value = id;
	$("#divAlternativas").append("<p id=al_"+id+"><a href=\"#\" onclick=\"removeFormField('al_"+id+"'); return false;\" class=\"remove\"></a><textarea name=\"data[Alternativa]["+id+"][nome]\" value=\"\" class=\"required\"></textarea></p>");
}
...
function removeAlternativaBD(id,campo) {
    ...
    $(document).ready(function(){
        $(".tipoForumalario").change(function() {
            ...
            var opcoes = '<div><label for="opcoes">Opções: </label></div><div><div id="divOpcoes"><input type="hidden" value="0" id="cont_id_op"/><p id="op_0"><a onclick="removeFormField(\'op_0\'); return false;" href="#" class="remove"></a><textarea value="" name="data[Opcao][0][nome]" class="required"></textarea></p></div><a onclick="addFormOpcoes(); return false;" href="#" class="add">Adicionar Opção</a></div>';
        	var texto = '<div><label for="opcoes">Opções: </label></div><div><div class="input textarea"><textarea id="PerguntaOpcoes" rows="6" cols="30" name="data[Opcao][0][nome]" class="required"></textarea></div></div>';
        	var alternativa = '<div><label for="alternativas">Alternativas: </label></div><div><div id="divAlternativas"><input type="hidden" value="0" id="cont_id_al"/><p id="al_0"><a onclick="removeFormField(\'al_0\'); return false;" href="#" class="remove"></a><textarea value="" name="data[Alternativa][0][nome]" class="required"></textarea></p></div><a onclick="addFormAlternativas(); return false;" href="#" class="add">Adicionar Alternativa</a>';
        	var simples = '';
