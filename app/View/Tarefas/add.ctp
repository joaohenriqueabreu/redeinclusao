  ...
  <?php echo $this->Form->create('Tarefa', array('role' => 'form', 'type'=>'file')); ?>
   ...
   <h4> Ata: <?=$nome_ata['Ata']['titulo']?> </h4>
      <div class="form-group">
          ...
          <?php echo $this->Form->input('resposta_levantamento_id', array('type' => 'hidden', 'value' => $levantamento));?>
          <?php echo $this->Form->input('ata_id', array('type' => 'hidden', 'value' => $ata));?>
          <?php echo $this->Form->input('ata_candidato_id', array('type' => 'hidden', 'value' => $ata_candidato));?>
      </div>
