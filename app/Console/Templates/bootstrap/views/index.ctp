...
<div class="<?php echo $pluralVar; ?> index">
	...
	<div class="row">
					...
					<div class="panel-heading">Ações</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo "<?php echo \$this->Html->link(__('<span class=\"glyphicon glyphicon-plus\"></span>&nbsp;&nbsp;Adicionar'), array('action' => 'add'), array('escape' => false)); ?>"; ?></li>
						<?php
							$done = array();
		...
		<div class="col-md-9">
			<p>
				<small><?php echo "<?php echo \$this->Paginator->counter(array('format' => __('<b>Página {:page}</b> (do total {:pages}) - <b>exibindo de {:start} a {:end}</b> (do total {:count} registro(s)')));?>"; ?></small>
			</p>
