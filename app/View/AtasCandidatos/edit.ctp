...
<div class="top-bar clearfix">
	<div class="page-title">
		<h1 class="page-header">Atas Candidato - <?=$this->Form->value('Candidato.nome')?></h1>
	</div>
</div>
<!-- Top Bar Ends -->
            ...
            <div class="col-md-12 col-sm-12 col-sx-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4>Editar</h4>
    				    <ul class="links">
                            <li><?php echo $this->Form->postLink(__('<i class="fa  fa-trash-o"></i>&nbsp;&nbsp;Deletar'), array('action' => 'delete', $this->Form->value('AtasCandidato.id'), $this->Form->value('AtasCandidato.candidato_id')), array('escape' => false), __('Deseja remover o registro # %s?', $this->Form->value('AtasCandidato.id'))); ?></li>
                    ...
                    <div class="panel-body">
                        <?php echo $this->Form->create('AtasCandidato', array('role' => 'form', 'type'=>'file')); ?>
