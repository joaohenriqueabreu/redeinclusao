...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Origens'), array('action' => 'index')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($origem['Candidato'] as $candidato): ?>
		<tr>
