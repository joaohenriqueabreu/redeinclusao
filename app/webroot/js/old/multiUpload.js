...
function multiUpload(id, filesdiv, options)
{
	...
	{
		html  = '<div><div class="c30p bold">Imagem</div><div class="c100 ac bold">Tamanho</div>';
		html += '<div class="c100 ac bold">excluir</div><div class="c30p bold">Progresso</div></div><div class="sep"></div>';
	 ...
	 */
	this.op = {
		swf:               '', // path to the swf file
		script:            '', // path to the upload script
		expressInstall:    null,
		scriptAccess:      'sameDomain',
		width:             171, // flash button width
		height:            33, // flash button height
