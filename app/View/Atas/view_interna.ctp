                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
            				    ...
            				    <ul class="links">
                                    ...
                                    <li><?php echo $this->Html->link(__('<i class="glyphicon glyphicon-edit"></i>&nbsp&nbsp;Editar'), array('action' => 'edit_interna', $ata['Ata']['id']), array('escape' => false)); ?> </li>
                            		<li>
                                        <?php
                                            if($ata['User']['id'] == $this->Session->read('Auth.User.id')){
                                                echo $this->Form->postLink(__('<i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;Deletar'), array('action' => 'delete_interna', $ata['Ata']['id']), array('escape' => false), __('Deseja remover o registro # %s?', $ata['Ata']['id']));
                                            }
                                        ?>
                                    </li>
                                    <li><?php echo $this->Html->link(__('<i class="fa fa-angle-double-left"></i>&nbsp; Voltar'), array('controller'=>'atas', 'action' => 'internas'), array('escape'=>false)); ?></li>
                            		<li><?php echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i>&nbsp&nbsp;Adicionar'), array('action' => 'add_interna'), array('escape' => false)); ?> </li>
            					</ul>
          			        </div>
                            <div class="panel-body">
                                ...
                                <div class="row no-gutter">
                                  <div class="col-lg-12 col-sm-6 col-sx-6">
                                    <label>Colaborador(es) Participante(s)</label>
                                    <p><?php
                                            $nomes = '';
                                            if(!empty($ata['Colaborador'])){
                                                foreach($ata['Colaborador'] as $colaborador){
                                                    $nome = explode(' ', $colaborador['nome']);
                                                    if(count($nome) > 1){
                                                        $nomes .= $nome[0].' '.$nome[1].'<br />';
                                                    }else{
                                                        $nomes .= $nome[0].'<br />';
                                                    }
                                                }
                                          ...
                                          <table class="table table-striped table-bordered table-hover">
                                              ...
                                              ?>
                                                  		<tr>
                                                  			...
                                                  			<td><?php echo $tarefa['por_que_fazer']; ?></td>
                                                  			<td><?php echo $tarefa['onde_faremos']; ?></td>
                                                  			...
                                                  			<td>
                                                                  <?php
                                                                      if(!empty($tarefa['anexo'])):
                                                                          echo '<div>'.$this->Html->link(__('<i class="glyphicon glyphicon-download-alt "></i>&nbsp&nbsp;Dowload'), '/files/tarefa/anexo/'.$tarefa['dir'].'/'.$tarefa['anexo'], array('target'=>'_blank', 'escape' => false)).'</div>';
                                                                      endif;
                                                                  ?>
                                                              </td>
