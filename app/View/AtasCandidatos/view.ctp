    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Ata Canditato - <?php echo h($ata['Candidato']['nome']); ?></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <div class="tab-pane fade in active" id = "cadastro">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4>Visualizar</h4>
            				    <ul class="links">
                                    <li><?php echo $this->Html->link(__('<i class="glyphicon glyphicon-print"></i>&nbsp&nbsp;Impressão'), 'javascript:abreJanela("'.$this->base.'/atas_candidatos/impressao/'.$ata['AtasCandidato']['id'].'");' , array('escape' => false)); ?> </li>
                                    <li><?php echo $this->Html->link(__('<i class="glyphicon glyphicon-edit"></i>&nbsp&nbsp;Editar'), array('action' => 'edit', $ata['AtasCandidato']['id']), array('escape' => false)); ?> </li>
                            		<li><?php echo $this->Form->postLink(__('<i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;Deletar'), array('action' => 'delete', $ata['AtasCandidato']['id'], $ata['AtasCandidato']['candidato_id']), array('escape' => false), __('Deseja remover o registro # %s?', $ata['AtasCandidato']['id'])); ?> </li>
                                    <li><?php echo $this->Html->link(__('<i class="fa fa-angle-double-left"></i>&nbsp; Voltar'), array('controller'=>'clientes', 'action' => 'view', $ata['AtasCandidato']['candidato_id']), array('escape'=>false)); ?></li>
                            		<li><?php echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i>&nbsp&nbsp;Adicionar'), array('action' => 'add', $ata['AtasCandidato']['candidato_id']), array('escape' => false)); ?> </li>
            					</ul>
          			        </div>
                            <div class="panel-body">
                                ...
                                <div class="row no-gutter">
                                    ...
                                    <p>
                                        <?php
                                            if(!empty($ata['AtasCandidato']['arquivo'])):
                                                echo $this->Html->link(__('<i class="glyphicon glyphicon-download-alt "></i>&nbsp&nbsp;Dowload'), '/files/atas_candidato/arquivo/'.$ata['AtasCandidato']['id'].'/'.$ata['AtasCandidato']['arquivo'], array('target'=>'_blank', 'escape' => false));
                                            endif;
                                        ?>
                                    </p>
                        		  </div>
                                  ...
                                  <div class="col-lg-4 col-sm-6 col-sx-6">
                                    ...
                                    <p><?php echo h($ata['AtasCandidato']['created']); ?> </p>
                        		  </div>
                        		</div>
                            </div>
                        </div>
                        ...
                        <div class="table-dataTable_wrapper panel-body">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4>Listagem</h4>
                                    <ul class="links">
                                        <li><a href="<?=$this->base?>/Tarefas/add?candidato=<?=$ata['Candidato']['id']?>&ata_candidato=<?=$ata['AtasCandidato']['id']?>" data-toggle="modal", data-target="#myLargeModalLabel"><i class="glyphicon glyphicon-plus"></i>&nbsp;Adicionar</a></li>
                                    </ul>
                                </div>
                                <div class="panel-body">
                                    <!-- Nav tabs -->
