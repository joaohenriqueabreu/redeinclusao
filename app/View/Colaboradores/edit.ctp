...
<div class="row">
    <div class="col-lg-12">
        <?php
            echo $this->Form->create('Colaborador', array('role'=>'form'));
            ...
            <div class="panel-body">
               ...
               <div class="row no-gutter">
                  <div class="col-lg-3 col-sm-3 col-sx-3">
                      <div class="form-group">
        					<?php echo $this->Form->input('ativo', array('required'=>'required', 'class' => 'form-control', 'options' => $this->Util->statusAtivo())); ?>
        				</div>
                  </div>
              </div>
            </div>
