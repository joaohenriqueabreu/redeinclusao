...
<?php echo $this->Html->scriptEnd(); ?>
  <?php echo $this->Form->create('Acao', array('role' => 'form', 'type'=>'file')); ?>
   <div class="modal-header">
       ...
       <h4 class="modal-title">Adicionar Tarefa - Ação <?=$tarefa['Tarefa']['tarefa']?></h4>
   </div>
   <div class="modal-body">
   <h4> Ata: <?=$nome_ata['Ata']['titulo']?> </h4>
      <div class="form-group">
          <?php echo $this->Form->input('acao', array('type' => 'hidden', 'value'=>'add'));?>
          <?php echo $this->Form->input('tarefa_id', array('type' => 'hidden', 'value' => $tarefa['Tarefa']['id']));?>
      </div>
      ...
      <div class="row no-gutter">
          <div class="col-lg-4 col-sm-1 col-sx-1">
              <div class="form-group">
                  <?php echo $this->Form->input('quando', array('type' =>'text', 'label' => 'Quando?', 'class' => 'form-control datepicker',  'onkeypress'=>'return OnlyNumbers(event)', 'required' => 'required'));?>
              </div>
          </div>
          <div class="col-lg-4 col-sm-1 col-sx-1">
              <div class="form-group">
                  <?php echo $this->Form->input('tempo_gasto', array('label' => 'Tempo Gasto (Minutos)', 'class' => 'form-control',  'onkeypress'=>'return OnlyNumbers(event)', 'required' => 'required'));?>
              </div>
          </div>
          <div class="col-lg-4 col-sm-1 col-sx-1">
              <div class="form-group">
                  <?php echo $this->Form->input('colaborador_id', array('empty'=>'Selecione', 'class' => 'form-control', 'required' => 'required'));?>
              </div>
          </div>
      </div>
      <div class="row no-gutter">
          <div class="col-lg-8 col-sm-6 col-sx-6">
              <div class="form-group">
