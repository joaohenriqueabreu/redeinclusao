...
function abreJanela(urlBoleto){
    window.open(urlBoleto,'Curriculo','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=1024,height=800');
}
