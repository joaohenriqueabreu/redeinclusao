            ...
            <div class="col-md-12 col-sm-12 col-sx-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4>Editar</h4>
    				    <ul class="links">
                            						    <li><?php echo $this->Form->postLink(__('<i class="fa  fa-trash-o"></i>&nbsp;&nbsp;Deletar'), array('action' => 'delete', $this->Form->value('ProjetosTiposPerguntasLevantamento.id')), array('escape' => false), __('Deseja remover o registro # %s?', $this->Form->value('ProjetosTiposPerguntasLevantamento.id'))); ?></li>
