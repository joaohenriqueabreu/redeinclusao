...
<?php echo $this->Html->scriptStart(array('block'=>'codesJavaScripts')); ?>
  $(document).ready(function(){
  	  ...
  	  var $validator = $("#AtaAddForm").validate({
                                ...
                                <div class="tab-pane" id = "tabs-2">
                                    ...
                                    ?>
                                          <div class="panel panel-default">
                                              ...
                                              <div class="panel-body">
                                                  <div class="form-group">
                                                      <?php echo $this->Form->input('cliente_id', array('name' => 'data[Tarefa]['.$i.'][cliente_id]', 'type' => 'hidden', 'value' => $this->params['pass'][0]));?>
                                                  </div>
                                                  <div class="row no-gutter">
