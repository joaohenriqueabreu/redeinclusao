...
?>
	...
	echo '<p>&nbsp;</p>';
	echo '<p>';
	echo __d('acl', 'Esta página permite controlar as permissões para os usuários');
	echo '</p>';
	echo '<p>&nbsp;</p>';
	?>
	<?php
    echo $this->Form->create('User');
    echo __d('acl', 'Usuário');
    echo '<br/>';
    ...
    <tr>
    	...
    	$headers = array($this->Paginator->sort(__d('acl', 'Usuário'), $user_display_field));
